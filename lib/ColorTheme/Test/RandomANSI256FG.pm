package ColorTheme::Test::RandomANSI256FG;
...
our %THEME = (
    v => 2,
    summary => 'A color theme which gives random 256-color ANSI foreground codes',
    dynamic => 1,
    args => {
        cache => {
            schema => 'bool*',
...
Show a color swatch of this theme:
 ...
 % show-color-theme-swatch Test/RandomANSI256FG

Specify number of colors:

 % show-color-theme-swatch Test/RandomANSI256FG=num,10
