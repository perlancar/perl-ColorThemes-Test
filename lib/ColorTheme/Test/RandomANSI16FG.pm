package ColorTheme::Test::RandomANSI16FG;
...
our %THEME = (
    v => 2,
    summary => 'A color theme which gives random 16-color foreground ANSI codes',
    dynamic => 1,
    args => {
        cache => {
            schema => 'bool*',
...
Show a color swatch of this theme:
 ...
 % show-color-theme-swatch Test/RandomANSI16FG

Specify number of colors:

 % show-color-theme-swatch Test/RandomANSI16FG=num,10
